-- VRTX Database Setup — Run in Supabase SQL Editor

-- Enums
CREATE TYPE theme AS ENUM ('cyber', 'gold', 'neon', 'rose', 'white');
CREATE TYPE mode AS ENUM ('todo', 'trabajo', 'deporte', 'parche', 'negocio');
CREATE TYPE tier AS ENUM ('CORE', 'LINKED', 'LEGENDARY');
...
CREATE INDEX idx_scans_chip_date ON scans(chip_id, scanned_at);
